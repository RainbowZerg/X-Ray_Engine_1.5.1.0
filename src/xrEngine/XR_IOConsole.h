...
protected:
	void __stdcall	Prev_log	();
	void __stdcall	Next_log	();
	void __stdcall	Begin_log	();
	void __stdcall	End_log		();
	
	void __stdcall	Find_cmd	();
	void __stdcall	Find_cmd_back();
	void __stdcall	Prev_cmd	();
	void __stdcall	Next_cmd	();
	void __stdcall	Prev_tip	();
	void __stdcall	Next_tip	();

	void __stdcall	Begin_tips	();
	void __stdcall	End_tips	();
	void __stdcall	PageUp_tips	();
	void __stdcall	PageDown_tips();
	
	void __stdcall	Execute_cmd	();
	void __stdcall	Show_cmd	();
	void __stdcall	Hide_cmd	();
	void __stdcall	Hide_cmd_esc();
	void __stdcall	SwitchKL	();
//	void __stdcall	GamePause	();
