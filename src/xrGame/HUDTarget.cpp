...
const u32 C_ON_ENEMY	= D3DCOLOR_RGBA(0xff,0,0,0x80);
const u32 C_ON_NEUTRAL	= D3DCOLOR_RGBA(0xff, 0xff, 0x80, 0x80);
const u32 C_ON_FRIEND	= D3DCOLOR_RGBA(0, 0xff, 0, 0x80);
const u32 C_DEFAULT		= D3DCOLOR_RGBA(0xff, 0xff, 0xff, 0x80);
