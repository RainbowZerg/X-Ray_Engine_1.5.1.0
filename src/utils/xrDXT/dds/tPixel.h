...
public:
    ...
    rgba_t(UCHAR _r, UCHAR _g, UCHAR _b,UCHAR _a) 
    {
        a = _a; 
        r = _r; 
        g = _g;
    ...
    {
        r = (UCHAR)nv::Clamp((int)((int)r + (int)v.r), 0, 255);   
        g = (UCHAR)nv::Clamp((int)g + (int)v.g, 0, 255);   
        b = (UCHAR)nv::Clamp((int)b + (int)v.b, 0, 255);   
        a = (UCHAR)nv::Clamp((int)a + (int)v.a, 0, 255);   
    ...
    friend rgba_t operator + (const rgba_t & v1, const rgba_t& v2)
    {
        ...
        return rgba_t((UCHAR)r, (UCHAR)g, (UCHAR)b, (UCHAR)a);
    }
...
public:
    ...
    rgba16_t(USHORT _r, USHORT _g, USHORT _b,USHORT _a) 
    {
        a = _a; 
        r = _r; 
        g = _g;
    ...
    {
        r = (UCHAR)nv::Clamp((int)r + (int)v.r, 0, 65535);   
        g = (UCHAR)nv::Clamp((int)g + (int)v.g, 0, 65535);   
        b = (UCHAR)nv::Clamp((int)b + (int)v.b, 0, 65535);   
        a = (UCHAR)nv::Clamp((int)a + (int)v.a, 0, 65535);   
    ...
    friend rgba16_t operator + (const rgba16_t & v1, const rgba16_t& v2)
    {
        ...
        return rgba16_t((UCHAR)r, (UCHAR)g, (UCHAR)b, (UCHAR)a);
    }

    friend rgba16_t operator / (const rgba16_t& v, float s)
    {
        return rgba16_t((USHORT)(v.r/s), 
            (USHORT)(v.g/s), 
            (USHORT)(v.b/s), 
            (USHORT)(v.a/s));
    }
    ...
    void set(USHORT _r, USHORT _g, USHORT _b, USHORT _a)
    {
        r = _r;
        g = _g;
        b = _b;
...
public:
    ...
    {
		if (numMIPMaps() == NULL) return NULL;
